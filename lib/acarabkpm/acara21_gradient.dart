...
// Halaman Login
class acara21 extends StatelessWidget {
  const acara21({super.key});
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Daftar halaman dengan gradient background
  final List<Widget> _pages = [
    const GradientPage(title: "🏠 Ini Halaman Home"),
    const GradientPage(title: "🔍 Ini Halaman Search"),
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => const acara21()),
                );
              },
            ),
          ],
